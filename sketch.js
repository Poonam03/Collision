...
function draw() {
 ...
 if(mObj.x-fObj.x<fObj.width/2+mObj.width/2&&fObj.x-mObj.x<fObj.width/2+mObj.width/2&&mObj.y-fObj.y<fObj.width/2+mObj.width/2&&fObj.y-mObj.y<fObj.width/2+mObj.width/2)
  {
    fObj.shapeColor="red";
    mObj.shapeColor="red";
  }
